 ...
 * 
 * <p>通过 taskOverTime 可以给任务指定超时时间，在任务超时会对其进行中断
 * 
 * <p>默认是对每个任务进行超时检测，通过 detectTimeoutOnEachTask = false 可以设置成对整体任务进行检测，即从第一个任务执行就计算超时时间
 * 
 * @author shanhm1991@163.com
 *
 */
@FomSchedule(cron = "0 0/7 * * * ?", threadCore = 4, taskOverTime = 3500, remark = "中断取消超时任务")
